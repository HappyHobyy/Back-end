...
public record UserLoginRequest(
    ...
    public record DefaultLogin(
        ...
        public User toUser() {
            return User.withoutId(null, email, User.UserType.OAUTH_DEFAULT, new User.Password(password), User.UserRole.ROLE_USER, null, null, deviceToken,null,null,null);
        }
    }
    ...
    public record OAuthLogin(
        ...
        public User toUser() {
            return User.withoutId(null, email,oAuth, null, User.UserRole.ROLE_USER, null, null, deviceToken,null,null,null);
        }
    }
}
